...
1. Type-1 holds the detector clicks (results + basis) from the high count side. The data in this file is not compressed. Generated by chopper2.
...
5. Final key storage file
	...
	amplification scheme; since EC/PA is typically carried out on
	more than one epoch, the header contains information on how many epochs
